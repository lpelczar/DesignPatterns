package org.lpelczar.behavioral.memento.editor;

import org.lpelczar.behavioral.memento.commands.ColorCommand;
import org.lpelczar.behavioral.memento.commands.MoveCommand;
    ...
    MouseAdapter colorizer =
        new MouseAdapter() {
          ...
          public void mousePressed(MouseEvent e) {
            ...
            if (target != null) {
              editor.execute(
                  new ColorCommand(editor, new Color((int) (Math.random() * 0x1000000))));
              repaint();
            }
          }
        };
